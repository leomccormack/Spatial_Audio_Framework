...
xcopy "C:\Program Files (x86)\Intel\oneAPI\mkl\latest\share\mkl\tools\builder\saf_mkl_custom_lp64.dll" "C:\Windows\System32\"
GOTO End
...
ECHO Copying files to correct folders...
cd /d "%~dp0"
xcopy "C:\Program Files (x86)\Intel\oneAPI\mkl\latest\share\mkl\tools\builder\saf_mkl_custom_ilp64.lib" "..\dependencies\Win64\lib" 
xcopy "C:\Program Files (x86)\Intel\oneAPI\mkl\latest\share\mkl\tools\builder\saf_mkl_custom_ilp64.dll" "C:\Windows\System32\"
GOTO End
