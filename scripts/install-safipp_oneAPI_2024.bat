...
IF NOT EXIST "C:\Program Files (x86)\Intel\oneAPI\ipp\latest\opt\ipp\tools" (
...
python "C:/Program Files (x86)/Intel/oneAPI/ipp/latest/opt/ipp/tools/custom_library_tool_python/main.py" -c -g -n saf_ipp_custom -p "" -ff "saf_ipp_list.txt" -arch=intel64
