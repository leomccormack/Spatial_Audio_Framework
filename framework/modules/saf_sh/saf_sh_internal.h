 ...
 *
 * Input Arguments:
 *     j1 - Wigner 3 j-symbol, j1
 *     j2 - Wigner 3 j-symbol, j2
 *     j3 - Wigner 3 j-symbol, j3
 *     m1 - Wigner 3 j-symbol, m1
 *     m2 - Wigner 3 j-symbol, m2
 *     m3 - Wigner 3 j-symbol, m3
 * Returns:
 *     factorial(n)
 */
 ...
 *
 * Input Arguments:
 *     N1 - order of first harmonic coeffient
 *     N2 - order of second harmonic coefficient
 *     N  - target order
 * Output Arguments:
 *     A  - gaunt matrix; FLAT: (N1+1)^2 x (N2+1)^2 x (N+1)^2
 */
