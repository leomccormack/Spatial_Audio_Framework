 ...
 * which is called twice to generate the high shelf parameters for the nearests thetas
 * in the lookup table. */
...
)
{
    ...
    interpHighShelfParams(theta, rho, &iG0, &iGInf, &iFc);       // TODO: wacky pointer syntax
