...
/* McLaren's Improved Snub Cube and Other New Spherical Designs in Three Dimensions", R. H. Hardin and
...
/* Gräf, M., & Potts, D. (2011). On the computation of spherical designs by a new optimization
...
/* (nearly) uniform arrangements (Sphere Covering)
 * Belger, M. (1989). JH Conway, NJA Sloane. Sphere packings, lattices and groups. Springer
 * Verlag New York‐Berlin‐Heidelberg‐London‐Paris Tokyo 1988, 663 pages, 112 illustrations,
 * DM 178.00, ISBN 0‐387‐96617‐X. Crystal Research and Technology, 24(1), 90-90. */
...
/* (nearly) uniform arrangements (3LD geosphere) */
/* 3LD - Library for Loudspeaker Layout Design; release 2, 2006/03/15 Copyright (c) 2006 Florian Hollerweger
   (floholl_AT_sbox.tugraz.at) and (c) 2002 Darren Weber. */
