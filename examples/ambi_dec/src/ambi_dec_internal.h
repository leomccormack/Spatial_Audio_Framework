 ...
 */
typedef enum _AMBI_DEC_PROC_STATUS{
...
typedef struct _ambi_dec
{
    ...
    AMBI_DEC_CODEC_STATUS codecStatus;
    ...
    /* flags */
    AMBI_DEC_PROC_STATUS procStatus;
    ...
    AMBI_DEC_CH_ORDER chOrdering;        /**< only ACN is supported */
    AMBI_DEC_NORM_TYPES norm;            /**< N3D or SN3D */
...
/**
 * Sets codec status (see 'AMBI_DEC_CODEC_STATUS' enum)
 */
void ambi_dec_setCodecStatus(void* const hCmp, AMBI_DEC_CODEC_STATUS newStatus);
 ...
 *
 * @param[in]  preset   See AMBI_DEC_LOUDSPEAKER_ARRAY_PRESETS enum
 ...
 */
void loadLoudspeakerArrayPreset(AMBI_DEC_LOUDSPEAKER_ARRAY_PRESETS preset,
