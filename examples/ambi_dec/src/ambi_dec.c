...
//    // 2d testing
//    int j;
//    float** ARRAYTEST, **ARRAYTEST2;
//    float**A, **B, **C;
//    ARRAYTEST = (float**)malloc2d_new(80000,50,sizeof(float));
//    for(i=0; i<80000; i++)
//        for(j=0; j<50; j++)
//            ARRAYTEST[i][j] = j;
//
//    free2d_new((void**)ARRAYTEST);
//
//
//    ARRAYTEST2 = (float**)malloc2d_new(50,80000,sizeof(float));
//    for(i=0; i<50; i++)
//        for(j=0; j<80000; j++)
//            ARRAYTEST2[i][j] = j;
//    free2d_new((void**)ARRAYTEST2);
//
//    A = (float**)malloc2d_c(30,20,sizeof(float));
//    B = (float**)malloc2d_c(20,50,sizeof(float));
//    C = (float**)malloc2d_c(30,50,sizeof(float));
//
//    cblas_sgemm(CblasRowMajor, CblasNoTrans, CblasNoTrans, 30, 50 , 20, 1.0f,
//                &A[0][0], 20,
//                &B[0][0], 50, 0.0f,
//                &C[0][0], 50);
////
...
//    A = (float**)malloc2d_new(80,50, sizeof(float), (void**)&testtttt);
//    B = (float**)malloc2d_new(50,30, sizeof(float), (void**)&testtttt);
//    C = (float**)malloc2d_new(80,30, sizeof(float), (void**)&testtttt);
//
////    cblas_sgemm(CblasRowMajor, CblasNoTrans, CblasNoTrans, 80, 30, 50, 1.0f,
////                (const float*)A, 50,
////                (const float*)B, 30, 0.0f,
////                (float*)C, 30);
////
//    free2d_new((void**)A, 0);
//    free2d_new((void**)B, 0);
//    free2d_new((void**)C, 0);
    ...
    //try indexing with [][], then try blas multiplications
