...
/**
 * Sets the beamforming order (see #_SH_ORDERS enum)
 *
...
/**
 * Sets the beamforming approach to employ (see #_STATIC_BEAM_TYPES enum)
 */
...
/**
 * Returns the beamforming approach employed (see #_STATIC_BEAM_TYPES enum)
 */
