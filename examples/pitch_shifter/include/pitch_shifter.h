 ...
 */
typedef enum _PITCH_SHIFTER_CODEC_STATUS {
    ...
    CODEC_STATUS_INITIALISING     /**< Codec is currently being initialised,
                                   *   input audio should not be processed. */
} PITCH_SHIFTER_CODEC_STATUS;

#define PITCH_SHIFTER_MAX_NUM_CHANNELS ( 64 )
#define PITCH_SHIFTER_MAX_SHIFT_FACTOR ( 2.0f )
#define PITCH_SHIFTER_MIN_SHIFT_FACTOR ( 0.5f )
#define PITCH_SHIFTER_PROGRESSBARTEXT_CHAR_LENGTH ( 256 )
...
/**
 * Returns current codec status (see 'PITCH_SHIFTER_CODEC_STATUS' enum)
 */
PITCH_SHIFTER_CODEC_STATUS pitch_shifter_getCodecStatus(void* const hPS);
