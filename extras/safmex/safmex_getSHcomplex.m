%SAFMEX_GETSHCOMPLEX compute complex spherical harmonics
%   Y = SAFMEX_GETSHCOMPLEX(ORDER, DIRS_RAD) computes spherical harmonics Y 
%   of order ORDER for all DIRS_RAD directions.
%
